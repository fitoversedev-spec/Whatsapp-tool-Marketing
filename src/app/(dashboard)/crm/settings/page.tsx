...
export default async function CrmSettingsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto">
      <PageHeader title="CRM settings" description="Admin-only. The full settings surface stays where it already lives — this just gathers the links relevant to the CRM section." />
