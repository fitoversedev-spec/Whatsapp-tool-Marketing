...
// WhatsApp-side only — the chatbot-captured BotLead feed, reached from the
// Sidebar's own "Bot leads" entry, not the CRM section. General/CRM leads
// (manual entry or import) live at /crm/leads instead — see docs/DECISIONS.md.
