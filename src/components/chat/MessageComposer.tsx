    ...
    <div className="border-t border-slate-200 p-2">
      {attachments.length > 0 && (
        <div className="flex flex-wrap gap-1.5 mb-2">
          {attachments.map((a, i) => (
            <span key={i} className="inline-flex items-center gap-1 text-xs bg-slate-100 rounded-lg px-2 py-1 max-w-[180px]">
        ...
        <div className="flex items-end gap-1.5">
          ...
          <div className="relative flex-1 min-w-0">
            ...
            <div
              ...
              className="min-h-[38px] max-h-40 overflow-y-auto rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:border-wa-green focus:ring-2 focus:ring-wa-green/30"
